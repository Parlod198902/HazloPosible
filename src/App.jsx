      ...
      <div className="hero-content">
        <div className="hero-text">
          ...
          <div className="hero-buttons">
            <button className="btn btn-donate" onClick={() => navigate('/donador/datos')}>
            ...
            <button className="btn btn-volunteer" onClick={() => navigate('/voluntarios/datos')}>
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/donador/datos" element={<DonadorDatosForm onContinue={() => navigate('/donador/seleccion')} />} />
      <Route path="/donador/seleccion" element={<DonadorSelection onNext={() => navigate('/donador/pago')} />} />
      ...
      <Route path="/voluntarios/seleccion" element={<VoluntarioSeleccion onNext={() => navigate('/voluntarios/horario')} />} />
      <Route path="/voluntarios/datos" element={<VoluntarioDatos onContinue={() => navigate('/voluntarios/seleccion')} />} />
